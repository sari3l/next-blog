...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-100 flex flex-col px-6">
        ...
        <div className="flex justify-between pb-2 my-2 text-xs lg:px-10">
          <div className="flex flex-col gap-2">
            <div className="flex items-center">
              Powered by
              <div className="inline-flex px-2 py-1 mx-2 space-x-2 bg-gray-200 rounded-full place-items-center">
                {powers.map((tool) => (
                  <a
                    key={tool.url}
                    className="leading-0  hover:text-gray-600"
                    href={tool.url}
                    target="_blank"
